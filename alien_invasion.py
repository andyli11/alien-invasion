...
class AlienInvasion:
    ...
    def _check_play_button(self, mouse_pos):
        ...
        if button_clicked and not self.stats.game_active:
            ...
            self._reset_game()
            # hide mouse cursor after clicking Play
    ...
    def _ship_hit(self):
        ...
        if self.stats.ships_left > 0:
            ...
            # update remaining ships on scoreboard
            self.scoreboard.prep_ships()
            self._reset_game()
            # pause
            sleep(0.5)
            ...
            # show mouse cursor again after game is finished
    ...
    def _create_fleet(self):
        ...
        available_space_y = (
            self.settings.screen_height - ship_height - (3 * alien_height)
        )
    ...
    def _update_screen(self):
        ...
        # make it visible above all other elements by drawing it last
